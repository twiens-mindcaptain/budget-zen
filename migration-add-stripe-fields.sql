...
-- Description: Adds Stripe customer ID, subscription ID, checkout session ID, and subscription timestamp
-- Date: 2026-01-22
...
COMMENT ON COLUMN profiles.subscription_started_at IS 'Timestamp when subscription was activated';
